...
const CreateCarForm: FC<Props> = (): JSX.Element => {
  ...
  const [selectedCategory, setSelectedCategory] = useState<ISelectCategory>({
    value: carCategory.none,
    label: carCategory.none,
  });
  ...
  const onSubmit = async (formData: FormValues) => {
    ...
    try {
      ...
      router.replace(linkConstants.admin_cars);
      revalidatePath(linkConstants.admin_cars);
    } catch (error: any) {
